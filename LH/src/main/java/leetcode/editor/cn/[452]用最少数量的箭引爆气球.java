package leetcode.editor.cn;//在二维空间中有许多球形的气球。对于每个气球，提供的输入是水平方向上，气球直径的开始和结束坐标。由于它是水平的，所以纵坐标并不重要，因此只要知道开始和结束的横
//坐标就足够了。开始坐标总是小于结束坐标。 
//
...
class Solution452 {
    ...
    public int findMinArrowShots(int[][] points) {
        ...
        //对所有气球按照左边端点进行从小到大排序
       // 表达式不要写a[1]-b[1]，不然遇到[[-2147483646,-2147483645],[2147483646,2147483647]]这个用例直接溢出。
